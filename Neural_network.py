...
<class 'list'>
(2, 4)
[[[1, 5, 6, 2], [3, 2, 1, 3]], [[5, 2, 1, 2], [64, 8, 4, 0]], [[2, 8, 5, 3], [1, 1, 9, 4]]]
<class 'list'>
(3, 2, 4)
[[4, 2, 3], [5, 1]]
<class 'list'>
...
inputs = np.array([1.0, 2.0, 3.0 ,2.5])
weights = np.array([[0.2, 0.8, -0.8, 1] ,
          [0.5, -0.91, 0.26, -0.5] ,
          [-0.26, -0.27, 0.17, 0.87]])
...
layer2_outputs = np.dot(layer1_outputs, weights2.T) + \
 biases2
...
'''output - [[-1.3065269   1.6581306  -0.11816405 -0.6801782   0.6663831 ]
...
'''output - [[-0.00133702  0.01077744 -0.01126826 -0.00730678]
 [-0.0038488   0.00094352 -0.00042171 -0.00286887]]
[[0. 0. 0. 0.]]'''
...
'''output - [[ 0.0000000e+00  0.0000000e+00  0.0000000e+00]
 [-3.2394189e-05 -2.9833174e-05 -2.7261351e-05]
 [-1.1703596e-04  3.0946774e-06 -8.1775004e-05]
 [-1.5538928e-04 -2.0428570e-05 -1.1227253e-04]
 [ 1.3543649e-04 -3.9138540e-04  3.6163940e-05]]'''
